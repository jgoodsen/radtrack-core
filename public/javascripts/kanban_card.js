...
$(function() {
    ...
    $.fn.update_kanban_card = function(options) {
        ...
        function init(parent) {
            ...
            parent.append(make_card_html(options.card));
        ...
        function make_card_html(card) {
            ...
            var card = options.card;
            var card_display = '<' + options.card_tag + ' id="' + make_card_id(card.id, options.id_prefix) + '" class="kanban_card kanban_backlog_card"' + ' project_id="' + card.project_id + '" card_id="' + card.id + '">';

            card_display += '<div class="card_header">';
    ...
    $.fn.kanban_card = function(options) {
        $(this).update_kanban_card(options);
    };
